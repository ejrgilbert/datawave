...
## Before accumulo-env.sh.bk is loaded, these environment variables are set and can be used in this file:
...
export ACCUMULO_LOG_DIR="${ACCUMULO_LOG_DIR:-/srv/logs/accumulo}"
